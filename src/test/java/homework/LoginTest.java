...
public class LoginTest {
    ...
    @Test
    public void verifyUserCanotLoginWithWrongCredentials() throws InterruptedException {
        ...
        WebElement login_form_password_input_field = driver.findElement(By.id(loginFormPasswordField_locator));
        // typeTextAt(login_form_password_input_field,"thegray");
        typeTextAt(login_form_password_input_field, "WRONG_PASSWORD");
        ...
        boolean isProfileLinkShown = isNavBarProfileLinkShown(navBarProfileLink_locator);
    ...
    boolean isNavBarProfileLinkShown(String el_id_locator) {
        boolean isShown = false;
        try {
            WebElement element = driver.findElement(By.id(el_id_locator));
            isShown = true;
        } catch (Exception ex) {
            System.out.println("NOT SHOWN: Web element with locator :: "+el_id_locator);
            isShown = false;
        }
